...
import HrComplaintCards from './components/HrComplaintCards';
import CeoComplaintCards from './components/CeoComplaintCards';
import { fetchComplaints,forwardComplaint } from './complaints/actions/EmpComplaintActions';
const data = [
...
const Sidebar = ({ isDarkMode, onMenuClick ,setActiveSection}) => {
  ...
  const menuItems = [
    ...
    { icon: <Users size={20} />, label: 'Complaints To Solve',
     onClick:()=>setActiveSection('Complaintstosolve')
  }
  ];
  ...
  return (
    <div className={`flex ${isDarkMode ? 'bg-gray-900 text-white' : 'bg-gray-100 text-gray-900'}`}>
      ...
      <div className="flex-1">
        ...
        <div className="p-6">
        {activeSection=== 'Complaintstosolve' && (
              <CeoComplaintCards />
            ) }
